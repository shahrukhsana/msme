...
const CategoryPicker = ({ selectedCategory, setSelectedcategory, extraData=[] }) => {
  ...
  const handleSelect = (country) => {
    setSelectedcategoryName(country.name);
    setSelectedcategory(country.id);
  ...
  return (
    <View> 
      ...
      <TouchableOpacity 
        ...
        <Text>{selectedCategoryName || 'Select Category'}</Text>
      </TouchableOpacity>
